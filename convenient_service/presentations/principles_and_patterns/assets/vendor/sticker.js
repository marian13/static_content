 ...
 * NOTE: Copied with ❤️.
 *
 * NOTE: Sticker.js - a Javascript library that allows you to create a Sticker Effect.
 * - https://github.com/cmiscm
 * - http://stickerjs.cmiscm.com
 * - https://codepen.io/BEscudelario/pen/OZZvZp
 * - https://github.com/cmiscm/stickerjs/blob/master/sticker.js
 * /
...
(function () {
  ...
  var sticker = {
      init: function init(dom) {
          ...
          /**
           * NOTE: Added the following line to original `sticker.js` source for idempotence.
           * - https://github.com/cmiscm/stickerjs/blob/master/sticker.js
           */
          if (dom.querySelector('.sticker-img')) return dom
          ...
          var value,
              ...
              back = createEl('div', {
                  ...
                  zIndex: 3,
                  /**
                   * NOTE: Removed the following line from original `sticker.js` source for sticker transparent background.
                   *
